...
const ReggaeSection = () => {
    ...
    const reggaeMusic = dataSong.filter(dataSong => dataSong.genre === "Reggae")
    ...
    return (
        ...
        <div className='overflow-y-scroll scrollbar-hide' >
            ...
            <div className='mx-10 2xl:mx-20 mt-20 xl:mt-16 2xl:mt-28 rounded-lg bg-gradient-to-t  from-[#FFB61D] via-[#FFB61D] to-transparent  hover:border-yellow-600  flex flex-wrap h-[6rem] xl:h-[8rem] 2xl:h-[10rem] justify-end relative pr-10'>
                <img className='absolute left-[2rem] bottom-[0rem] xl:w-[10rem] h-[10rem] 2xl:w-[15rem] 2xl:h-[15rem]' src={reggae} alt='' /><br />
                <p className='absolute bottom-[2rem] text-white font-bold text-3xl 2xl:text-5xl ml-[2rem]'>Reggae</p>
            </div>
