...
const FooterNav = () => {
  ...
  return (
    <>
    {/* <MusicPlayerPhone/> */}
    <div className={ artist ? 'fixed bottom-0 w-screen bg-black grid grid-cols-6 py-3 h-[80px] xl:h-[90px] border-t border-gray-700 ' : 'fixed bottom-0 w-screen bg-black grid grid-cols-5 py-3 h-[80px] xl:h-[90px] border-t border-gray-700 ' }>
        ...
        <NavLink to={"/"} className={({ isActive }) => isActive ? 'grid border-b-[0.2rem] mx-2 border-mainPurple ' : "grid border-l-[0.3rem] border-transparent"}>
            <div className='cols-span-1'>
