    ...
    <div className='lg:w-[90%] xl:w-5/6 2xl:w-2/3 mx-auto b'>
        <div className='text-white flex  w-full mt-20 '>
            <div className='w-3/4  mx-auto lg:flex lg:w-full'>
                { !editArtist ?
                    <img className='w-52 sm:w-52 md:w-60 lg:w-52 lg:h-52 xl:h-auto xl:w-60 rounded-full mx-auto' src={shakira} alt="" />
                    :
                    <div className='relative cursor-pointer '>
                        <img className='w-52 sm:w-52 md:w-60 lg:w-52 lg:h-52 xl:h-auto xl:w-60 rounded-full border-2 border-[#7339E5] opacity-40 mx-auto' src={shakira} alt="" />
                ...
                <div className='lg:ml-10 xl:ml-20 lg:w-[70%]  flex flex-col items-center lg:block '>
                    {
                        ...
                        <h2 className='lg:text-4xl text-4xl xl:text-6xl 2xl:text-7xl font-bold mb-10 mx-auto'>Shakira</h2>
                        </div>
                        :
                    ...
                    <div className=' flex flex-col justify-end items-center lg:items-start '>
                        <p className='lg:text-xl xl:text-2xl 2xl:text-3xl text-[#989898] font-semibold'>Nickname: { !editArtist ? <span className='text-white'>Shushaki</span> : <input className='bg-transparent border-b focus:outline-none focus:ring-0  border-[#7339E5] text-center text-white' placeholder='Shusaki' type="text" /> } </p>
                        <p className='lg:text-xl xl:text-2xl 2xl:text-3xl text-[#989898] font-semibold'>Email: { !editArtist ? <span className='text-white'>shushaki@gmail.com</span> : <input className='bg-transparent border-b focus:outline-none focus:ring-0 border-[#7339E5]  text-center text-white' placeholder='Shusaki' type="text" />  } </p>
