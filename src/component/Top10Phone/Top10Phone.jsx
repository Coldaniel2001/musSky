        ...
        <div className=' bg-black mx-5 rounded-md text-white lg:mb-10 '>
            <div className="flex overflow-x-scroll w-full whitespace-no-wrap gap-5 ">
                <div className='w-full min-w-[25rem] grid grid-cols-9  bg-[#D9D9D9] items-center rounded bg-opacity-20 m-2 mx-auto'>
                    <img className='col-span-2 w-3/4 ml-2 rounded-full' src={rihanna} alt="" />
                ...
                <div className='min-w-[25rem] grid grid-cols-9  bg-[#D9D9D9] items-center rounded bg-opacity-20 m-2 mx-auto'>
                    <img className='col-span-2 w-3/4 ml-2 rounded-full' src={shakira} alt="" />
                    <div className='col-span-5 my-4'>
                ...
                <div className='min-w-[25rem] grid grid-cols-9  bg-[#D9D9D9] items-center rounded bg-opacity-20 m-2 mx-auto'>
                    <img className='col-span-2 w-3/4 ml-2 rounded-full' src={melendi} alt="" />
                    <div className='col-span-5 my-4'>
                        <p className='text-xl font-bold'>Rihanna</p>
                        <p>You will never see</p>
                    </div>
