			...
			<div className='sm:flex justify-center '>
					<form className='2xl:flex 2xl:justify-between items-center w-[95%] -mb-8' action="">
						<div className='flex 2xl:w-1/6 flex-col items-center justify-around h-[12rem] pb-5 sm:border-b border-gray-600 2xl:border-transparent'>
							...
							{
								changeInformation ?
								<span className='text-xl font-semibold'>Jaurewin</span>
								:
						...
						<div className='sm:flex 2xl:w-5/6  justify-between 2xl:ml-10 mt-5'>
							<div className='flex sm:flex-col sm:justify-around sm:h-[6rem]'>
								...
								<span className='text-detailsGray w-[35%] sm:w-full text-lg ml-10 sm:ml-0'>Victor</span>
							</div>
							<div className='flex sm:flex-col sm:justify-around sm:h-[6rem]'>
								...
								<span className='text-detailsGray w-[35%] sm:w-full text-lg ml-10 sm:ml-0'>Jauregui</span>
							</div>
							<div className='flex sm:flex-col sm:justify-around sm:h-[6rem]'>
								...
								{
									changeInformation ?
									<span className='text-detailsGray w-[35%] sm:w-full text-lg ml-10 sm:ml-0'>vicjaudom@gmail.com</span>
									:
									<input  className='bg-[#7239e57a] border-2 border-[#7339E5] rounded' 
									type="text"  
									placeholder="vicjaudom@gmail.com" 
									value={user.email}
									name="email"
									onChange={handleChangeInput}
									 />
							...
							<div className='flex sm:flex-col sm:justify-around sm:h-[6rem]'>
								...
								<span className='text-detailsGray w-[35%] sm:w-full text-lg ml-10 sm:ml-0'>28/02/2023</span>
							</div>
						</div>
