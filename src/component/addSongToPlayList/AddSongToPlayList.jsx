    ...
    <div className='mt-[2vh] max-h-[35vh] lg:max-h-[25vh] overflow-y-scroll scrollbar-hide'>
        <div className=' h-14 w-full flex gap-8 lg:gap-4 sm:px-4 border-b border-gray-500 py-2'>
            <div className='flex h-full items-center w-[15%] gap-2'>
                ...
                <img className='h-[60%] md:h-full rounded' src={antonioJose} alt="" />
            </div>
            <div className='w-[60%] flex flex-col justify-center'>
                <p className='text-white text-[0.8rem] sm:text-[1rem] font-bold'>Antonio Jose</p>
                <p className='text-gray-500 truncate text-[0.8rem] sm:text-md'>Wilston, te tengo enamoradommmmmmmmm</p>
            </div>
