...
const HomePage = () => {
  return (
    <div className='bg-gradient-to-tr from-black via-black to-[#7339E5] lg:h-screen lg:flex'>
      ...
      <div className='hidden lg:block w-full lg:w-[25%] xl:w-[25%] 2xl:w-[18%] pt-10 border-r-2 border-gray-700'>
        <SidebarLeft />
      </div>
      <div className='w-full pt-10 sm:pt-10 lg:pt-0 lg:w-[75%] xl:w-[75%] 2xl:w-[67%]'>
        <CenterSection />
      </div>
